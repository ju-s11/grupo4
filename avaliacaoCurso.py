...
def add_avaliacao_ao_criterio(id_curso: int, id_avaliacao: int) -> int: 
  ...
  novoCriterio: dict = {'curso': id_curso, 'avaliacoes': [id_avaliacao]} #se o criterio não existir, cria um novo
    ...
    if criterio['curso'] == id_curso: 
      ...
      for avaliacao in criterio['avaliacoes']:
        if avaliacao == id_avaliacao:
          ...
          if len(criterio['avaliacoes']) == 0:  #se criterio nao tem mais avaliaçoes, o mesmo é excluido
...
if __name__=="__main__":
  ...
  #add
  print("add avaliaçao id:(" + str(id_av) + ") ao curso id:(" + str(id_curso) + ") -> " + str(add_avaliacao_ao_criterio(id_curso, id_av)))
  print("add avaliaçao id:(" + str(id_av+1) + ") ao curso id:(" + str(id_curso) + ") -> " + str(add_avaliacao_ao_criterio(id_curso, id_av+1)))

  #get
  print("get criterio do curso id:(" + str(id_curso) + ") -> " + str(get_criterio(id_curso)))
  print("get criterio do curso id:(" + str(id_curso+1) + ") -> " + str(get_criterio(id_curso+1))) #curso inexistente

  #del
  print("del avaliaçao id:(" + str(id_av) + ") do curso id:(" + str(id_curso) + ") -> " + str(del_avaliacao_do_criterio(id_curso, id_av)))
  print("del avaliaçao id:(" + str(id_av-1) + ") do curso id:(" + str(id_curso) + ") -> " + str(del_avaliacao_do_criterio(id_curso, id_av-1))) #avaliacao inexistente
  print("del avaliaçao id:(" + str(id_av) + ") do curso id:(" + str(id_curso+1) + ") -> " + str(del_avaliacao_do_criterio(id_curso+1, id_av)))  #curso inexistente

  #get
  print("get criterio do curso id:(" + str(id_curso) + ") -> " + str(get_criterio(id_curso)))

  #del
  print("del avaliaçao id:(" + str(id_av+1) + ") do curso id:(" + str(id_curso) + ") -> " + str(del_avaliacao_do_criterio(id_curso, id_av+1)))
